    ...
    return (
        <Grid container>
                ...
                <Grid item xs={12} direction="row">
                    <Typography variant="caption" display="block" className={classes.disclaimer}> For printing purposes, the use of Chrome, Firefox, or Safari browsers are recommended, the printout may not be formatted as well by other browsers. </Typography>
                </Grid>  
                </Grid>     
                <Grid item xs={12} >
                    <Conclusion />
